...
![ミニフィグ向き判定（左から正面、右面、左面、背面）](./images_yu_kimura/predict_fig_direction.png 'ミニフィグの向き判定')
...
本文で用いたモデルの画像は、Google Drive に共有フォルダとして配置しました。
拡大して見たい方は、次のリンク、もしくは QR コードからご覧ください。
モデルの画像をまとめた Google Drive の QR コードを図 11 に示します。
